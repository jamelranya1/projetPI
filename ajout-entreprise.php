                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">ajouter entreprise</h3>
                                    </div>
                                    <!-- /card heading -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/ajout-entreprise.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="entrer nom entreprise" name="nom_entreprise">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label for="nom">matricule<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                        ...
                                        <div class="form-group">
                                            <label for="nom">adresse<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                        ...
                                        <div class="form-group">
                                            <label for="nom">telephone<span style="color:red"> * </span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="nom">fax<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                        ...
                                        <div class="form-group">
                                            <label for="nom">login<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                        ...
                                        <div class="form-group">
                                            <label for="nom">motdepasse<span style="color:red"> * </span></label>
                                            <input type="Password" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="entrer password" name="motdepasse">
