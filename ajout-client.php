                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">ajouter client</h3>
                                    </div>
                                    <!-- /card heading -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <form action="controller/ajout-client.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="telsss">tel<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                        ...
                                        <div class="form-group">
                                            <label for="motdepasse">motdepasse<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter motdepasse" name="motdepasse">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter telephone" name="prix">
