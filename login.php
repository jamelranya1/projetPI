            ...
            <div class="dt-login__content-wrapper">
                ...
                <div class="dt-login__bg-section">
                    ...
                    <div class="dt-login__bg-content">
                        <!-- Login Title -->
                        <h1 class="dt-login__title">resto</h1>
                        <!-- /login title -->
                ...
                <div class="dt-login__content">
                    ...
                    <div class="dt-login__content-inner">
                        ...
                        <!-- Form -->
                        <form action="controller/Verif-admin.php" method="post">
                            ...
                            <!-- Form Group -->
                            <div class="form-group">motdepasse</label>
                                <input type="password" class="form-control" id="password-1" placeholder="entrer Password"  name="motdepasse" required>
                            </div>
                            <!-- /form group -->
