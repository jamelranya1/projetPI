            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste client</h1>
                    </div>
                    <!-- /page header -->
                                              ...
                                              ?>
                                                ...
                                                <td><?php echo $donnees['adresse']; ?></td>
                                                  <td><?php echo $donnees['login']; ?></td>
	                                                ...
	                                                <td>
	                                                	<a href="modifier-client.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-success">modifier</a>
	                                                	<a href="controller/suppclient.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-danger">supprimer</a>
	                                                </td>
                                            	</tr>
                                               <?php     }?>
                                            </tbody>
