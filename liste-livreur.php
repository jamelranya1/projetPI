...
$req=$bdd->query('SELECT * FROM livreur');
session_start();
            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste livreur</h1>
                    </div>
                    <!-- /page header -->
                                              ...
                                              ?>
                                            	<tr>
	                                                ...
	                                                <td>
	                                                	...
	                                                	<a href="controller/supplivreur.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-danger">supprimer</a>
	                                                </td>
                                            	</tr>
                                              <?php     }?>
                                            </tbody>
