                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">modifier client</h3>
                                    </div>
                                    <!-- /card heading -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/modifclient.php?id=<?php echo $donnees['id'] ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter login" value="<?php echo $donnees['login']; ?>" name="login">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter  motdepasse" value="<?php echo $donnees['motdepasse']; ?>" name="motdepasse">
