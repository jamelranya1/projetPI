                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">ajouter appel offre</h3>
                                    </div>
                                    <!-- /card heading -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/ajout-appel_offre.php" method="post">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="nom">nom_entreprise<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter entreprise" name="nom_entreprise">
                                            
                                        </div>
                                         <div class="form-group">
                                            <label for="nom">prix<span style="color:red"> * </span></label>
                                        ...
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nom">description<span style="color:red"> * </span></label>
                                            <textarea  class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="entrer description" row="20" col="40" name="description"></textarea>
                                            
                                        </div>
                                       
                                        
                                        <div class="form-group">
                                            <label for="nom">date_deb<span style="color:red"> * </span></label>
                                            <input type="date" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter date debut" name="date_deb">
                                            
                                        </div>
                                         <div class="form-group">
                                            <label for="nom">date_fin<span style="color:red"> * </span></label>
                                            <input type="date" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter date fin" name="date_fin">
