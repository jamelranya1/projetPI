                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">modifier admin</h3>
                                    </div>
                                    <!-- /card heading -->
                                    ...
                                    <form action="controller/modifadmin.php?id=<?php echo $donnees['id'] ?>" method="post">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="Enter email" value="<?php echo $donnees['email']; ?>" name="email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="entrer password" value="<?php echo $donnees['motdepasse']; ?>" name="motdepasse">
