            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        <h1 class="dt-page__title">liste restaurant</h1>
                    </div>
                    <!-- /page header -->
                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                            	<tr>
	                                                ...
	                                                <td>
	                                                	<a href="modifier-restaurant.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-success">modifier</a>
	                                                	<a href="controller/supprestaurant.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-danger">supprimer</a>
	                                                </td>
                                            	</tr>
                                               <?php  } ?>
                                            </tbody>
