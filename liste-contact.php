                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <?php
                                        ...
                                        <strong>supprimer!</strong> vous avez supprimez un contact .
                                        ...
                                        <table id="data-table" class="table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                                ...
                                                <td>
                                                <a href="controller/suppContact.php?id=<?php echo $donnees['id']?>" class="btn btn-outline-danger">Supprimer</a>
