                            ...
                            <div class="dt-card">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <div class="dt-card__heading">
                                        <h3 class="dt-card__title">ajouter livreur</h3>
                                    </div>
                                    <!-- /card heading -->
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <!-- Form -->
                                    <form action="controller/ajout-livreur.php" method="post">
                                        ...
                                        <!-- Form Group -->
                                        <div class="form-group">
                                            <label for="nom">tel<span style="color:red"> * </span></label>
                                            <input type="text" class="form-control" 
                                                   aria-describedby="emailHelp1"
                                                   placeholder="entrer tel" name="tel">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" placeholder="Enter password" name="=motdepasse">
