                            ...
                            <div class="row form-inputs">
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="Nom" class="input-field custom-input-field"  name="nom" type="text" required data-error="NEW ERROR MESSAGE">
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="prenom" class="input-field custom-input-field"  name="prenom" type="text" data-error="NEW ERROR MESSAGE">
										<label class="input-label custom-input-label" >
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="adresse" class="input-field custom-input-field"  name="adresse" type="text" data-error="NEW ERROR MESSAGE">
										<label class="input-label custom-input-label" >
											<i class="fa fa-envelope icon icon-field"></i>
										</label>
									</span>
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="tel" class="input-field custom-input-field"  name="tel" type="text" data-error="NEW ERROR MESSAGE">
										<label class="input-label custom-input-label" >
											<i class="fa fa-envelope icon icon-field"></i>
										</label>
									</span>
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="nomrepas" class="input-field custom-input-field"  name="nomrepas" type="text" data-error="NEW ERROR MESSAGE">
										<label class="input-label custom-input-label" >
											<i class="fa fa-envelope icon icon-field"></i>
										</label>
									</span>
                                ...
                                <button type="submit" class="btn btn-outline-dark">Valider</button>                                </div>
                                <!-- Submit Button Ends -->
