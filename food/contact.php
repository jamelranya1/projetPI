                    ...
                    <?php 
                        ...
                        <form  method="post" action="controller/contact.php">
                            <div class="row form-inputs">
                                ...
                                <div class="col-sm-6 form-group custom-form-group">
                                    <span class="input custom-input">
										<input placeholder="Email" class="input-field custom-input-field"  name="email" type="email" data-error="NEW ERROR MESSAGE">
										<label class="input-label custom-input-label" >
                                ...
                                <div class="form-group custom-form-group col-sm-12">
                                    <textarea placeholder="Sujet" name="sujet" cols="25" rows="7" data-error="NEW ERROR MESSAGE"></textarea>
                                </div>
                                <!-- Last Name Field Ends -->
                                <!-- Message Field Starts -->
                                <div class="form-group custom-form-group col-sm-12">
                                    <textarea placeholder="Message" name="message" cols="25" rows="7" data-error="NEW ERROR MESSAGE" ></textarea>
                                </div>
                                <!-- Message Field Ends -->
