                                            ...
                                            <tbody>
                                              ...
                                              ?>
                                            	<tr>
	                                                ...
	                                                <td>
	                                                	<a href="modifier-admin.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-success">modifier</a>
	                                                	<a href="controller/suppAdmin.php?id=<?php echo $donnees['id']; ?>" class="btn btn-outline-danger">supprimer</a>
	                                                </td>
                                            	</tr>
                                              <?php     }?>
                                            </tbody>
